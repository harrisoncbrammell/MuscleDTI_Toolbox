...
%
%  alt_mask_size: If specified, this is a 3 element vector containing the
...
%  v. 1.0.1 (updated help), 5 Aug 2025, Bruce Damon
%
% ACKNOWLEDGMENTS
...
if form_alt_mask==1
    ...
    alt_mask(alt_mask<0.5) = 0;
    alt_mask(alt_mask>0) = 1;
